...
void DeleteDataForOne()
{
    ...
    file.close();
    cout << " All the file content  erase successfully";
    exit(-1);
}
...
class RemoveTeacher
{
  public:
    void RemoveTeacher_()
    {
        ...
        file.close();
        cout << "Teachers Remove successfully";
        exit(-1);
    }
};
...
void now()
{
    ...
    int i=0;
    system("cls");
    cout << "*********************************************\n****--Made BY JIVESH ANAND & HARSH GARG--****\n*********************************************\n";
    while(i!=5)
    {
    ...
    case 2:
        l.storeDataInFile();
         cout<<"** TEACHER HAS BEEN REGISTERED SUCCESSFULLY**"<<endl;
         cout<<endl<<endl<<endl;
        break;
    case 3:
        s.FromFile();
